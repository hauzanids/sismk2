               ...
               <div class="col-lg-12">
                  <!-- <div class="breadcrumb_iner"> -->
                     <!-- <div class="breadcrumb_iner_item"> -->
                      <?php $daftar_photography = \App\Photography::all(); ?>
                          @if(session('success'))
            ...
            <div class="row">
               <div class="col-lg-8 mb-5 mb-lg-0">
                  <div class="blog_left_sidebar">
                    @foreach($daftar_photography as $photography)
                      <article class="blog_item">
                        <div class="blog_item_img">
                          <h1>{{$photography->judul}}</h1>
                        </div>
                        <div class="blog_details">
                          <h4>{{$photography->deskripsi}}</h4>
                        </div>
                        <div class="blog_details">
                          <a href="{{ route('photography.download', $photography->id) }}">
                        ...
                        <a href="/photography/{{$photography->id}}/delete" class="btn btn-danger float-right"onclick="return confirm('Apakah anda yakin ingin menghapus materi ini?')">Delete</a>
                        @endif
                      </article>
                      <hr class="border">
                    @endforeach
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Materi Photography</h5>
