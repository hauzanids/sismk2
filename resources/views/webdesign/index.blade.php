               ...
               <div class="col-lg-12">
                  <!-- <div class="breadcrumb_iner"> -->
                     <!-- <div class="breadcrumb_iner_item"> -->
                      <?php $daftar_webdesign = \App\Webdesign::all(); ?>
                          @if(session('success'))
            ...
            <div class="row">
               <div class="col-lg-8 mb-5 mb-lg-0">
                  <div class="blog_left_sidebar">
                    @foreach($daftar_webdesign as $webdesign)
                      <article class="blog_item">
                        <div class="blog_item_img">
                          <h1>{{$webdesign->judul}}</h1>
                        </div>
                        <div class="blog_details">
                          <h4>{{$webdesign->deskripsi}}</h4>
                        </div>
                        <div class="blog_details">
                          <a href="{{ route('webdesign.download', $webdesign->id) }}">
                        ...
                        <a href="/webdesign/{{$webdesign->id}}/delete" class="btn btn-danger float-right"onclick="return confirm('Apakah anda yakin ingin menghapus materi ini?')">Delete</a>
                        @endif
                      </article>
                      <hr class="border">
                    @endforeach
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Materi Web Design</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
                          <div class="modal-body">
                      <form action="{{ route('webdesign.store') }}" method="POST" enctype="multipart/form-data">
                      {{csrf_field()}}
