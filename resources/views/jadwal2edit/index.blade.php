...
<body>
 ...
 -->        </tr>
      ...
      <a href="/jadwal2" class="btn btn-warning float-right">Back</a>
        <!-- <div class="progress-table-wrap">
          <div class="progress-table">
            ...
            <div class="table-row">
              ...
              <div class="visit">{{$jadwal2->jamselesai}}</div>
