               ...
               <div class="col-lg-12">
                  <!-- <div class="breadcrumb_iner"> -->
                     <!-- <div class="breadcrumb_iner_item"> -->
                      <?php $daftar_multimedia = \App\Multimedia::all(); ?>
                          @if(session('success'))
            ...
            <div class="row">
               <div class="col-lg-8 mb-5 mb-lg-0">
                  <div class="blog_left_sidebar">
                    @foreach($daftar_multimedia as $multimedia)
                      <article class="blog_item">
                        <div class="blog_item_img">
                          <h1>{{$multimedia->judul}}</h1>
                        </div>
                        <div class="blog_details">
                          <h4>{{$multimedia->deskripsi}}</h4>
                        </div>
                        <div class="blog_details">
                          <a href="{{ route('multimedia.download', $multimedia->id) }}">
                        ...
                        <a href="/multimedia/{{$multimedia->id}}/delete" class="btn btn-danger float-right"onclick="return confirm('Apakah anda yakin ingin menghapus materi ini?')">Delete</a>
                        @endif
                      </article>
                      <hr class="border">
                    @endforeach
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Materi Multimedia</h5>
                  ...
                  <div class="blog_right_sidebar">
                     ...
                     <aside class="single_sidebar_widget post_category_widget">
                        ...
                        <ul class="list cat-list">
                           <li>
                              <a href="/nirmanmultimediaa" class="d-flex">
                                 <p>Nirmana</p>
                              </a>
                           </li>
                           <li>
