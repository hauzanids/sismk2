...
<body>
               ...
               <div class="col-lg-12">
                  <!-- <div class="breadcrumb_iner"> -->
                     <!-- <div class="breadcrumb_iner_item"> -->
                      <?php $daftar_jadwal3 = \App\Jadwal3::all(); ?>
                          @if(session('success'))
  ...
  <section class="button-area">
    <div class="section-top-border">
        <h3 class="mb-30">Jadwal Kelas 12</h3>
 ...
 -->        </tr>
      ...
      <a href="/jadwal3" class="btn btn-warning float-right">Back</a>
        <!-- <div class="progress-table-wrap">
          <div class="progress-table">
            ...
            @foreach($daftar_jadwal3 as $jadwal3)
            <div class="table-row">
              <div class="serial">{{$jadwal3->jammulai}}</div>
              <div class="visit">{{$jadwal3->jamselesai}}</div>
              <div class="visit">{{$jadwal3->senin}}</div>
              <div class="visit">{{$jadwal3->selasa}}</div>
              <div class="visit">{{$jadwal3->rabu}}</div>
              <div class="visit">{{$jadwal3->kamis}}</div>
              <div class="visit">{{$jadwal3->jumat}}</div>
            </div>
            @endforeach
          </div>
        </div>
