                      ...
                      <article class="blog_item">
                        <div class="blog_item_img">
                          ...
                          <a class="blog_item_date">
                            <h3>{{$informasi->tanggal->format('d')}}</h3>
                            <p>{{$informasi->tanggal->format('M')}}</p>
                          </a>
                        </div>
                        ...
                        @can('isStaff')
                        <a href="/beranda/{{$informasi->id}}/edit" class="btn btn-warning">Edit</a>
                        <a href="/beranda/{{$informasi->id}}/delete" class="btn btn-danger"onclick="return confirm('Apakah anda yakin ingin menghapus informasi ini?')">Delete</a>
                        @endcan
                      </article>
                    @endforeach
